...
title: "About"
url: "/about/"
summary: "Philip Shurpik - AI infrastructure, LLM pipelines, production ML"
hideMeta: true
ShowToc: false
---

I architect and build AI infrastructure that scales from proof-of-concept to millions of daily
operations. 15+ years in software engineering, 8+ of them in production AI/ML: currently
...
goes into our hardest problems:

- **Self-hosted open-source LLMs.** I lead the migration off API models: vLLM, FP8/NVFP4, MTP, and
  LLM-as-judge evaluation (rating, pairwise, MQM). Gemma 4 31B now matches Gemini 3.1 Flash Lite
  quality at ~10x lower cost.
- **Agentic AI workflows.** Google ADK with MCP and RAG, to accelerate analyst investigations and
  detect impersonation and fraud.
- **Multimodal pipelines.** LLM translation across 100+ languages, video analysis, embeddings and
  retrieval optimization.
- **Observability and evaluation.** Org-wide LLM tracing, prompt management and cost attribution
  on Langfuse.

I lead our Data+ML team and set engineering standards across the org. About 60% of my time stays in
